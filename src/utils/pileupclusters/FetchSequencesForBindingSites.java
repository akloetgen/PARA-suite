...
public class FetchSequencesForBindingSites {
	...
	public void fetchSequences(String referenceFile, String bindingSitesFile,
		...
		try {
			...
			while ((bindingSite = br.readLine()) != null) {
				...
				String chr = splittedLine[1];
				int start = Integer.parseInt(splittedLine[2]);
				int end = Integer.parseInt(splittedLine[3]);
				...
				fileWriter.write(StringUtil.join("\t", splittedLine)
